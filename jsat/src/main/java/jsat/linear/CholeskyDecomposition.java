...
public class CholeskyDecomposition implements Serializable
{
    ...
    public Vec solve(Vec b)
    {
        ...
        //First solve L y = b
        Vec y = LUPDecomposition.forwardSub(L, b);
        //Sole L^T x = y
        Vec x = LUPDecomposition.backSub(L, y);
    ...
    public Matrix solve(Matrix B)
    {
        ...
        //First solve L y = b
        Matrix y = LUPDecomposition.forwardSub(L, B);
        //Sole L^T x = y
        Matrix x = LUPDecomposition.backSub(L, y);
    ...
    public Matrix solve(Matrix B, ExecutorService threadpool)
    {
        ...
        //First solve L y = b
        Matrix y = LUPDecomposition.forwardSub(L, B, threadpool);
        //Sole L^T x = y
        Matrix x = LUPDecomposition.backSub(L, y, threadpool);
