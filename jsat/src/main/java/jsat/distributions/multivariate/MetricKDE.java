...
/**
 * MetricKDE is a generalization of the {@link jsat.distributions.empirical.KernelDensityEstimator} to the multivariate case.
 * A {@link jsat.distributions.empirical.kernelfunc.KernelFunction} is used to weight the contribution of each data point, and a
