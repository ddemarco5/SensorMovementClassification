...
/**
 * The Product Kernel Density Estimator is a generalization of the {@link jsat.distributions.empirical.KernelDensityEstimator} to the multivariate case.
...
public class ProductKDE extends MultivariateKDE
{
    ...
    /**
     * Creates a new KDE that uses the {@link jsat.distributions.empirical.kernelfunc.EpanechnikovKF} kernel.
     */
    public ProductKDE()
    {
